...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-704-erd-s-problem-704-e9a8dc01-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-704"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-704-erd-s-problem-704-e9a8dc01-v1",
      "problem_contract_sha256": "6b1f2692aa474d54bb88584b976f3adc474f5c904c1a5e0087300c1fab72121c",
      "problem_id": "problem:um-ep-704-erd-s-problem-704-e9a8dc01",
      "route_id": "route:um-ep-704-erd-s-problem-704-e9a8dc01-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-704-erd-s-problem-704-e9a8dc01-source-fidelity-01",
      "graph_id": "graph:um-ep-704-erd-s-problem-704-e9a8dc01-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-704-erd-s-problem-704-e9a8dc01-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-704-erd-s-problem-704-e9a8dc01-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $G_n$ be the unit distance graph in $\\mathbb{R}^n$, with two vertices joined by an edge if and only if the distance between them is $1$. Estimate the chromatic number $\\chi(G_n)$. Does it grow exponentially in $n$? Does $ \\lim_{n\\to \\infty}\\chi(G_n)^{1/n} $ exist?"
          },
          "statement_sha256": "59f2d879ecca1913a0359e748b4c8a29f7a7ab1982de205de59bd86ec3901217"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-704-erd-s-problem-704-e9a8dc01-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-704-erd-s-problem-704-e9a8dc01-root",
      "route_id": "route:um-ep-704-erd-s-problem-704-e9a8dc01-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-704-fd85cb388868",
        "url": "https://www.unsolvedmath.com/problems/EP-704"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
